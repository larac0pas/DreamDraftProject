...
void calculateComplement(unordered_map<string, Player>& players, Player* starter, int week) { // updates complement values for players in given map to given starter in given week
	for (auto it : players) {
...
void calculateComplements(unordered_map<string, Player>& players, Player* starter1, Player* starter2, int week) { // needed to store comp2 values directly
	for (auto it : players) {
...
int main() {
	...
	for (int i = 1; i <= 16; i++) {
		...
		calculateComplement(QBs, QB, i);
		calculateComplements(RBs, RB1, RB2, i);
		calculateComplements(WRs, WR1, WR2, i);
		calculateComplement(TEs, TE, i);
	}
